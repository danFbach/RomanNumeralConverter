...
namespace RomanNumeralConvert
{
    class RomToDec
    {
		...
		number = 0;
            Console.Write("Please enter the Numeral from I to x(10,000) that"
                + "you would like converted to Roman Numeral.");
